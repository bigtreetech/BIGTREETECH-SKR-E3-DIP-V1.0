...
#define STRING_CONFIG_H_AUTHOR "Ofloo" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 PRO TMC2208"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 88.01
  #define DEFAULT_bedKi 14.84
  #define DEFAULT_bedKd 348.04
 ...
 *
 */
// only uncomment when the plug is changed from z_min to probe
//#define Z_MIN_PROBE_PIN 3 // Pin pc14 STM32F103RCT6 is mapped to pin 3
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -3.225   // Z offset: -below +above  [the nozzle]
